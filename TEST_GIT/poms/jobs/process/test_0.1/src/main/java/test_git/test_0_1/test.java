...
public class test implements TalendJob {
	...
	private final String projectName = "TEST_GIT";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream("test_git/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 19512 characters generated by Talend Open Studio for Big Data on the 16
 * septembre 2020 à 18:30:24 CEST
 ************************************************************************************************/